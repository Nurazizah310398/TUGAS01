package com.example.nurazizah_163303030269_tugas01_7tipagib;
...
public class SendMessage extends Activity implements OnItemSelectedListener {
	
	private String TAG = SendMessage.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spinner = (Spinner) findViewById(R.id.list_item_contact);
	...
	private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(SendMessage.this,
